/* =========================================================
   HELP WANTED — SPONGEBOB INTERNATIONAL DUB DATABASE

   title = localized name of the SpongeBob TV series
...
const dubs = [
...

    {
        language: "Bulgarian",
        flag: "🇧🇬",
        title: "Спондж Боб Квадратни Гащи",
        versions: []
    },
...

    {
        language: "Ukrainian",
        flag: "🇺🇦",
        title: "Губка Боб Квадратні Штани",
        versions: []
    },
...

    {
        language: "Zulu",
        flag: "🇿🇦",
        title: "SpongeBob Amabhulukwe",
        versions: [
            { name: "Zulu title", info: "SpongeBob Amabhulukwe" },
            { name: "Alternate title", info: "SpongeBob SquarePants" }
        ]
    },

    {
        ...
        versions: [
            { name: "Avi Go!", info: "Aeviek fan-made dub" }
        ],
        realFandub: true,
        details: {
            type: "Fan dub",
...

    {
        ...
        versions: [
            { name: "Internet Archive", info: "Upcoming" }
        ],
        realFandub: true,
        details: {
            type: "Fan dub",
...

    {
        ...
        versions: [
            { name: "Bondian Dubbing Studios", info: "Google Drive — upcoming" }
        ],
        realFandub: true,
        details: {
            type: "Fan dub",
...

    {
        ...
        title: "Lponge Lhcen",
        versions: [
            { name: "Veoh", info: "Formerly available" }
        ],
        realFandub: true,
        details: {
            type: "Fan dub",
...

    {
        ...
        versions: [
            { name: "Project BR", info: "Google Drive" }
        ],
        realFandub: true,
        details: {
            type: "Fan dub",
...

    {
        ...
        versions: [
            { name: "BFTT Studios", info: "Google Drive" }
        ],
        realFandub: true,
        details: {
            type: "Fan dub",
...

    {
        ...
        versions: [
            { name: "Media Hyper Studio", info: "Google Drive; YouTube upcoming" }
        ],
        realFandub: true,
        details: {
            type: "Fan dub",
...

    {
        ...
        title: "SpongeBob SquarePants",
        versions: [
            { name: "Fan dub", info: "Google Drive; YouTube season 10 upcoming" }
        ],
        realFandub: true,
        details: {
            type: "Fan dub",
...

    {
        ...
        versions: [
            { name: "Latvian Project Studio", info: "YouTube upcoming" }
        ],
        realFandub: true,
        details: {
            type: "Fan dub",
...

    {
        ...
        versions: [
            { name: "Fan dub", info: "Google Drive / YouTube upcoming" }
        ],
        realFandub: true,
        details: {
            type: "Fan dub",
...

    {
        ...
        title: "Сунѓерот Боб",
        versions: [
            { name: "Project BR — 2017", info: "Google Drive — formerly available" }
        ],
        realFandub: true,
        details: {
            type: "Fan dub",
...

    {
        ...
        versions: [
            { name: "Project BR — 2018", info: "Google Drive — formerly available" }
        ],
        realFandub: true,
        details: {
            type: "Fan dub",
...

    {
        ...
        title: "Bob Esponja",
        versions: [
            { name: "Occitan Dubbing Studio", info: "Google Drive — upcoming" }
        ],
        realFandub: true,
        details: {
            type: "Fan dub",
...

    {
        ...
        title: "Biinichigens",
        versions: [
            { name: "Love 2 Dub Ojibwe", info: "YouTube" }
        ],
        realFandub: true,
        details: {
            type: "Fan dub",
...

    {
        ...
        title: "Bob Esponja",
        versions: [
            { name: "Soberana TV", info: "YouTube — Sponge WorldLand Fandubs" }
        ],
        realFandub: true,
        details: {
            type: "Fan dub",
...

    {
        ...
        title: "Bob Esponja Calça Quadrada",
        versions: [
            { name: "Fan dub", info: "YouTube / Google Drive" }
        ],
        realFandub: true,
        details: {
            type: "Fan dub",
...

    {
        ...
        versions: [
            { name: "Chromium", info: "Google Drive / YouTube" }
        ],
        realFandub: true,
        details: {
            type: "Fan dub",
